...
$_lang['setting_formbuilder.email_from_regex_desc']             = 'De regex om het e-mailadres voor het e-mail van veld te valideren, hiermee kun je het e-mailadres bijvoorbeeld controleren of het domein wel juist ivm de mail server. Standaard is "^(([a-zA-Z0-9_\+\.\-]+)@([a-zA-Z0-9_.\-]+)\.([a-zA-Z]{2,5}){1,25})$".';
...
$_lang['formbuilder.label_form_email_desc']                     = 'Indien aangevinkt zal er een e-mail verstuurd worden naar het opgegeven e-mailadres.';
$_lang['formbuilder.label_form_email_to']                       = 'E-mail aan';
$_lang['formbuilder.label_form_email_to_desc']                  = 'Het e-mailadres waar de e-mail heen gestuurd word.';
$_lang['formbuilder.label_form_email_from']                     = 'E-mail van';
$_lang['formbuilder.label_form_email_from_desc']                = 'Het e-mailadres waaruit de e-mail van gestuurd word.';
...
$_lang['formbuilder.label_form_reply_email']                    = 'Formulier bevestigings e-mail';
...
$_lang['formbuilder.label_form_reply_email_to_desc']            = 'Het e-mailadres veld waar de e-mail heen gestuurd word.';
$_lang['formbuilder.label_form_reply_email_from']               = 'Bevestigings e-mail van';
$_lang['formbuilder.label_form_reply_email_from_desc']          = 'Het e-mailadres waaruit de bevestigings e-mail van gestuurd word.';
...
$_lang['formbuilder.plugins_desc']                              = 'Aan een formulier kunnen plugins gekoppeld worden, die getriggerd worden op de \'<code>onBeforePost</code>\', \'<code>onValidatePost</code>\', \'<code>onValidateFailed</code>\', \'<code>onValidateSuccess</code>\', en \'<code>onAfterPost</code>\' events.';
...
$_lang['formbuilder.form_error_exists']                         = 'Een formulier met deze naam bestaat reeds. Definieer een andere naam.';
